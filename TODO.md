...
[U] Make agent work in both synchronously and asynchronously.
...
[F] Supervisor can trigger an agent/tool to run in background and do other operations and wait for the result when necessary or has dependency.